...
% ─── LOI CAM ON ──────────────────────────────────────────────
\cleardoublepage
\input{front-matter/acknowledgment}

% ─── TOM TAT & ABSTRACT (VIET - ANH - PHAP) ──────────────────
\cleardoublepage
\input{front-matter/abstract-vi}
\cleardoublepage
\input{front-matter/abstract-en}
\cleardoublepage
\input{front-matter/abstract-fr}

% ─── DANH MUC ────────────────────────────────────────────────
\tableofcontents
\listoffigures
\listoftables
\input{front-matter/abbreviations}
...
% ─── PHU LUC ─────────────────────────────────────────────────
\appendix
\input{appendices/appendix-sample}
\input{appendices/appendix-commands}
